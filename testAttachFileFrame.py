...
def newMessage():
    ...
    text_mail_frame.grid_rowconfigure(2, weight=1)
    
    write_mail_frame = tk.Frame(text_mail_frame)
    write_mail_frame.pack(side="top", fill="both", expand=True, padx=2, pady=2)

    mail_entry = tk.Text(write_mail_frame, wrap="word", width=950, bd=1, relief="solid")
    mail_entry.grid(row=0, column=0, sticky="w", pady=2)

    attach_file_frame = tk.Frame(text_mail_frame)
    attach_file_frame.pack(side="top", fill="both", expand=True, padx=2, pady=2)

    lmail_entry = tk.Text(attach_file_frame, wrap="word", width=950, bd=2, relief="solid")
    lmail_entry.grid(row=0, column=0, sticky="w", pady=2)
